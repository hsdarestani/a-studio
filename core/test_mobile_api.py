...
class MobileApiTests(TestCase):
    ...
    def test_mobile_registration_and_project_creation_are_disabled(self):
        ...
        created = self.client.post(
            ...
            data=json.dumps({
                "name": "New Project",
                "business_type": "Test",
                "description": "Should not be created from the App Store client.",
                "language": "de",
            }),
            content_type="application/json",
            **headers,
    ...
    def test_mobile_payload_is_existing_project_coordination_only(self):
        ...
        self.assertEqual(config.json()["mode"], "customer_project_companion")
        ...
        self.assertTrue(capabilities["project_requests"])
        ...
        self.assertFalse(capabilities["code_execution"])
